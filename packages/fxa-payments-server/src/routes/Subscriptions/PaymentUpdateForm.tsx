...
export const PaymentUpdateForm = ({
  ...
  usePaypalButtonSetup(setPaypalScriptLoaded, paypalButtonBase);
  ...
  const currencyCode = plan && plan.currency ? plan.currency : 'USD';
  /* istanbul ignore next */
  const priceId = plan && plan.plan_id ? plan.plan_id : 'UNKNOWN';
